...
- [x] Factories completas: Necesitamos terminar el CategoryFactory y EventFactory para que el seeder no falle.

- [x] Ejecución del Seeder: Poblar la base de datos con los 10 artistas y 20 espectadores de prueba.
...
- [x] Control de Acceso Real: Reactivar el middleware auth para que solo usuarios logueados con rol artist puedan publicar.
...
- [x] Formulario de Creación de Eventos: Crear la vista .jsx que envíe los datos a la ruta que hemos probado en Postman.

- [x] Feedback de Usuario: Mostrar mensajes de éxito o error tras intentar crear un evento.
...
- [x] Documentación Técnica: Actualizar el README.md con las instrucciones para levantar el proyecto con Docker y las rutas de la API.
